...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  {
    \setbeamertemplate{frame footer}{from presentation of dr. Viliam Lisy}
    \usebackgroundtemplate{
      \includegraphics[width=\textwidth, height=\textheight, keepaspectratio]{../img/presentation-gacr-2018-generalization-to-other-domains.png}
    }
    \begin{frame}[standout]
    \end{frame}
  }
