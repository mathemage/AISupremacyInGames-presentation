...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  {
    \setbeamertemplate{frame footer}{\colorcite\url{https://en.wikipedia.org/wiki/Deep_Blue_versus_Garry_Kasparov}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  {
    \setbeamertemplate{frame footer}{\colorcite\url{https://youtu.be/0X-NdPtFKq0?t=16m57s}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  {
    \usebackgroundtemplate{
      \includegraphics[width=\paperwidth, keepaspectratio]{../img/cepheus-screen.png}
    }
    \setbeamertemplate{frame footer}{\colorcite\url{http://poker.srv.ualberta.ca/}}
    \begin{frame}{}
      \vskip 0.6\paperheight
      \color{black}
      a~massive use of \emph{Counterfactual Regret Minimization\textsuperscript{+}} (\cfrP):
      \begin{itemize}[<+- | alert@+>]
          \color{black}
          \tiny
        \item game-theoretic analogy to the \emph{gradient descent}
        \item parameters (weights) of neural networks $\sim$ strategies
        \item loss $\sim$ \emph{counterfactual values}
        \item gradient $\sim$ \emph{counterfactual regrets}
        \item trained neural network (optimal weights) $\sim$ solution to the game (Nash equilibrium)
      \end{itemize}
    \end{frame}
  }
